...
// rv32ip contains the pipelined processor datapath/control path.
...
module p_cpu #(
    ...
    // Memory-mapped input. Reads from ordinary addresses come from RAM.
    assign core_dmem_dataout = access_input ? external_n :
                               access_output ? 32'b0 :
                                               ram_dmem_dataout;

    // MMIO stores must not also modify the aliased data-RAM location.
    ...
    // imem is word-addressed; bits [17:2] address its 64K words.
    imem #(
