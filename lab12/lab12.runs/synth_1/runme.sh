...
HD_PWD='D:/DLCOEXP/lab12/lab12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab12_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab12_top.tcl
